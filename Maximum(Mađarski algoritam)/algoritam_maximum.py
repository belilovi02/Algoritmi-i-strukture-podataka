...
#----------------------------------------------------------------------------------------------------------------
# Pronađe sve najveće elemente u matrici(redovi i kolone) te ih sabere
def main():

   # matrica_zarade = np.array([[7, 1, 8, 4, 6, 5, 2, 9, 3, 1],
    ...
    matrica_zarade = np.random.randint(low = 1, high = 9, size = (8,8))              
    x = '                              '
    y = '                          '

    print("********************************POČETNA MATRICA********************************\n")
    print(x , matrica_zarade[0])
    print(x , matrica_zarade[1])
    print(x , matrica_zarade[2])
    print(x , matrica_zarade[3])
    print(x , matrica_zarade[4])
    print(x , matrica_zarade[5])
    print(x , matrica_zarade[6])
    print(x , matrica_zarade[7], "\n")      
    
    

    maksimalni_iznos = np.max(matrica_zarade)
    matrica_potrosnje = maksimalni_iznos - matrica_zarade
    pozicija_rjesenja = madjarski_algoritam(matrica_potrosnje.copy())
    rjesenje, matrica_rjesenje = izracun_odogovora(matrica_zarade, pozicija_rjesenja)

    print("********************************NOVA MATRICA********************************\n")
    #print(f"Najveći mogući iznos je: {rjesenje:.0f}\n\nNova matrica izgleda ovako:\n{matrica_rjesenje}")

    print(y, "Najveće moguće rjesenje:", rjesenje , y, "\n")
    ...
    print(y, matrica_rjesenje[5])
    print(y, matrica_rjesenje[6])
    print(y, matrica_rjesenje[7], "\n")     
